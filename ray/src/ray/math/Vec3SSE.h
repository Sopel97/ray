...
namespace ray
{
    ...
    struct alignas(alignof(__m128)) Vec3<float>
    {
        ...
        constexpr Vec3<float> reciprocal() const
        {
            return Vec3<float>::broadcast(1.0f) / *this;
        }
        ...
        {
            return Normal3<float>(AssumeNormalized{}, *this * invLength());
        }
    ...
    constexpr Vec3<float> operator-(const Point3<float>& lhs, const Point3<float>& rhs)
    {
        return Vec3<float>(_mm_sub_ps(lhs.v, rhs.v));
    }

    constexpr Point3<float> operator-(const Point3<float>& lhs, const Vec3<float>& rhs)
    {
    ...
    constexpr Vec3<float> operator+(const Vec3<float>& lhs, const Vec3<float>& rhs)
    {
    ...
    constexpr Vec3<float> operator*(const Vec3<float>& lhs, float rhs)
    {
        return lhs * Vec3<float>::broadcast(rhs);
    }

    constexpr Vec3<float> operator*(const Normal3<float>& lhs, float rhs)
    {
        return Vec3<float>(lhs) * Vec3<float>::broadcast(rhs);
    }

    constexpr Vec3<float> operator*(float lhs, const Vec3<float>& rhs)
    {
        return rhs * Vec3<float>::broadcast(lhs);
    }
    ...
    constexpr Vec3<float> operator*(float lhs, const Normal3<float>& rhs)
    {
        return Vec3<float>(rhs) * Vec3<float>::broadcast(lhs);
    }
    ...
    constexpr Normal3<float> operator-(const Normal3<float>& v)
    {
        return Normal3<float>(AssumeNormalized{}, -v.x, -v.y, -v.z);
    }

    constexpr Vec3<float> operator-(const Vec3<float>& v)
    {
        return Vec3<float>(-v.x, -v.y, -v.z);
    }

    constexpr Point3<float> operator-(const Point3<float>& v)
    {
        return Point3<float>(-v.x, -v.y, -v.z);
    }
}
...
namespace ray
{
    ...
    {
        // mul first 3 components of v, sum it, and store in the first component, return first component
        return _mm_cvtss_f32(_mm_dp_ps(a, b, 0b0001'0111));
    }
